      ...
      describe 'using a custom day of week in month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, week, day) values (1, 2, 5);",
            "insert into event_recurrences (event_id, week, day) values (1, -2, 4);",
            "select distinct date from recurring_events_for('2008-04-01 12:00pm', '2008-07-25 12:00pm', 'UTC', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-05-09'],
            ['2008-05-22'],
      ...
      describe 'using a custom month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, month) values (1, 2);",
            "insert into event_recurrences (event_id, month) values (1, 7);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-07-25 12:00pm', 'UTC', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-25'],
            ['2009-02-25'],
      ...
      describe 'using a custom day of month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, day) values (1, 28);",
            "insert into event_recurrences (event_id, day) values (1, 7);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-04-28 12:00pm', 'UTC', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-04-28'],
            ['2009-04-07'],
      ...
      describe 'using a custom month and day of month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, month, day) values (1, 7, 28);",
            "insert into event_recurrences (event_id, month, day) values (1, 7, 7);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-07-07 12:00pm', 'UTC', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-07'],
            ['2008-07-28'],
      ...
      describe 'using a custom day of week in month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, week, day) values (1, 2, 5);",
            "insert into event_recurrences (event_id, week, day) values (1, -2, 4);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2011-06-25 12:00pm', 'UTC', NULL);"
          ]).should == [
            ['2008-05-25'],
            ['2009-05-08'],
            ['2009-05-21'],
      ...
      describe 'using a custom month and day of week in month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-07-10 12:00pm', 'UTC', NULL);"
          ]).should == [
            ['2009-04-25'],
            ['2009-05-08'],
            ['2009-05-21'],
