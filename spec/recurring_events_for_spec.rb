...
describe 'recurring_events_for' do
  it "should include events on a date inside of the range" do
    executing([
      ...
      "select date from recurring_events_for('2008-04-24 12:00pm', '2008-04-26 12:00pm', '0', NULL);"
    ]).should == [
      ['2008-04-25']
    ]
  end
  ...
  it "should include events on the date of the start of the range" do
    executing([
      "insert into events (date, frequency) values ('2008-04-25', 'once');",
      "select date from recurring_events_for('2008-04-25 12:00pm', '2008-04-26 12:00pm', '0', NULL);"
    ]).should == [
      ['2008-04-25']
    ]
  end
  ...
  it "should include events on the date of the end of the range" do
    executing([
      "insert into events (date, frequency) values ('2008-04-25', 'once');",
      "select date from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00pm', '0', NULL);"
    ]).should == [
      ['2008-04-25']
    ]
  end
  ...
  it "should include events on the date of the end of the range when the range ends at midnight" do
    executing([
      "insert into events (date, frequency) values ('2008-04-25', 'once');",
      "select date from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00am', '0', NULL);"
    ]).should == [
      ['2008-04-25']
    ]
  end
  ...
  it "should include events starting and ending inside the range" do
    executing([
      ...
      "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-27 12:00pm', '0', NULL);"
    ]).should == [
  ...
  it "should include events starting inside the range" do
    executing([
      ...
      "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-26 12:00pm', '0', NULL);"
    ]).should == [
  ...
  it "should include events ending inside the range" do
    executing([
      ...
      "select starts_at, ends_at from recurring_events_for('2008-04-25 12:00pm', '2008-04-27 12:00pm', '0', NULL);"
    ]).should == [
  ...
  it "should include events starting at the end of the range" do
    executing([
      "insert into events (starts_at, ends_at, frequency) values ('2008-04-25 12:00pm', '2008-04-26 12:00pm', 'once');",
      "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00pm', '0', NULL);"
    ]).should == [
      ['2008-04-25 12:00:00', '2008-04-26 12:00:00']
    ]
  end
  ...
  it "should include events ending at the start of the range" do
    executing([
      "insert into events (starts_at, ends_at, frequency) values ('2008-04-25 12:00pm', '2008-04-26 12:00pm', 'once');",
      "select starts_at, ends_at from recurring_events_for('2008-04-26 12:00pm', '2008-04-27 12:00pm', '0', NULL);"
    ]).should == [
      ['2008-04-25 12:00:00', '2008-04-26 12:00:00']
    ]
  end
  ...
  it "should include events encapsulating the range" do
    executing([
      ...
      "select starts_at, ends_at from recurring_events_for('2008-04-25 12:00pm', '2008-04-26 12:00pm', '0', NULL);"
    ]).should == [
  ...
  describe 'time zone offset' do
    it "should return starts_at and ends_at in UTC" do
      executing([
        "insert into events (starts_at, ends_at, frequency) values ('2008-04-25 12:00pm', '2008-04-26 12:00pm', 'once');",
        "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-27 12:00pm', '-5 hours', NULL);"
      ]).should == [
        ['2008-04-25 12:00:00', '2008-04-26 12:00:00']
      ]
    end
  ...
  describe 'recurring' do
    ...
    it "should only include events before or on the until date" do
      executing([
        ...
        "select date from recurring_events_for('2008-04-24 12:00pm', '2008-04-29 12:00pm', '0', NULL);"
      ]).should == [
        ['2008-04-25'],
        ['2008-04-26'],
        ['2008-04-27']
    ...
    it "should only include limit recurrences of each event" do
      executing([
        ...
        "select date from recurring_events_for('2008-04-19 12:00pm', '2008-04-29 12:00pm', '0', 3)"
      ]).should == [
        ['2008-04-20'],
        ['2008-04-21'],
        ['2008-04-22'],
    ...
    describe 'cancellations' do
      it "should not include cancelled recurrences" do
        executing([
          ...
          "select date from recurring_events_for('2008-04-26 12:00pm', '2008-04-26 1:00pm', '0', NULL);"
        ]).should == []
      end
      ...
      it "should still include uncancelled recurrences" do
        executing([
          "insert into events (id, date, frequency) values (1, '2008-04-25', 'daily');",
          "insert into event_cancellations (event_id, date) values (1, '2008-04-26')",
          "select date from recurring_events_for('2008-04-25 12:00pm', '2008-04-27 12:00pm', '0', NULL);"
        ]).should == [
          ['2008-04-25'],
          ['2008-04-27']
        ]
      ...
      it "should not include additional recurrences for events restricted by count" do
        executing([
          ...
          "insert into event_cancellations (event_id, date) values (1, '2008-04-26')",
          "select date from recurring_events_for('2008-04-25 12:00pm', '2008-04-28 12:00pm', '0', NULL);"
        ]).should == [
          ['2008-04-25'],
          ['2008-04-27']
        ]
      ...
      it "should include additional recurrences when specifying a limit" do
        executing([
          "insert into events (id, date, frequency) values (1, '2008-04-25', 'daily');",
          "insert into event_cancellations (event_id, date) values (1, '2008-04-26')",
          "select date from recurring_events_for('2008-04-25 12:00pm', '2008-04-29 12:00pm', '0', 3);"
        ]).should == [
          ['2008-04-25'],
          ['2008-04-27'],
          ['2008-04-28']
    ...
    describe 'daily' do
      it "should include the event once for each day" do
        executing([
          "insert into events (date, frequency) values ('2008-04-25', 'daily');",
          "select date from recurring_events_for('2008-04-01 12:00pm', '2008-04-26 1:00pm', '0', NULL);"
        ]).should == [
          ['2008-04-25'],
          ['2008-04-26']
        ]
    ...
    describe 'weekly' do
      it "should include the event once for each week" do
        executing([
          ...
          "select date from recurring_events_for('2008-04-01 12:00pm', '2008-05-08 12:00pm', '0', NULL);"
        ]).should == [
          ['2008-04-25'],
          ['2008-05-02']
        ]
      ...
      describe 'using a custom day of week' do
        it "should include the event once for each occurrence" do
          executing([
            ...
            "select distinct date from recurring_events_for('2008-04-01 12:00pm', '2008-05-02 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-04-29'],
            ['2008-05-01']
    ...
    describe 'monthly' do
      it "should include the event once for each month" do
        executing([
          ...
          "select date from recurring_events_for('2008-03-01 12:00pm', '2008-06-24 12:00pm', '0', NULL);"
        ]).should == [
          ['2008-04-25'],
          ['2008-05-25']
        ]
      ...
      describe 'using a custom day of month' do
        it "should include the event on the specified days" do
          executing([
            ...
            "insert into event_recurrences (event_id, day) values (1, 4);",
            "select distinct date from recurring_events_for('2008-04-01 12:00pm', '2008-05-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-04-28'],
            ['2008-05-04']
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, day) values (1, 28);",
            "insert into event_recurrences (event_id, day) values (1, 4);",
            "select distinct date from recurring_events_for('2008-04-01 12:00pm', '2008-06-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-04-28'],
            ['2008-05-04']
      ...
      describe 'using a custom day of week in month' do
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, week, day) values (1, 2, 5);",
            "insert into event_recurrences (event_id, week, day) values (1, -2, 4);",
            "select distinct date from recurring_events_for('2008-04-01 12:00pm', '2008-07-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-05-09'],
            ['2008-05-22'],
    ...
    describe 'yearly' do
      it "should include the event once for each year" do
        executing([
          ...
          "select date from recurring_events_for('2007-04-01 12:00pm', '2010-04-24 12:00pm', '0', NULL);"
        ]).should == [
          ['2008-04-25'],
          ['2009-04-25']
        ]
      ...
      describe 'using a custom month' do
        it "should include the event in the specified months" do
          executing([
            ...
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2009-07-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-25'],
            ['2009-02-25'],
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, month) values (1, 2);",
            "insert into event_recurrences (event_id, month) values (1, 7);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-07-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-25'],
            ['2009-02-25'],
      ...
      describe 'using a custom day of month' do
        it "should include the event on the specified days" do
          executing([
            ...
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2009-04-28 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-04-28'],
            ['2009-04-07'],
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, day) values (1, 28);",
            "insert into event_recurrences (event_id, day) values (1, 7);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-04-28 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-04-28'],
            ['2009-04-07'],
      ...
      describe 'using a custom month and day of month' do
        it "should include the event on the specified days" do
          executing([
            ...
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2009-07-07 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-07'],
            ['2008-07-28'],
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, month, day) values (1, 7, 28);",
            "insert into event_recurrences (event_id, month, day) values (1, 7, 7);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-07-07 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-07'],
            ['2008-07-28'],
      ...
      describe 'using a custom day of week in month' do
        it "should include the event on the specified days" do
          executing([
            ...
            "insert into event_recurrences (event_id, week, day) values (1, 2, 5);",
            "insert into event_recurrences (event_id, week, day) values (1, -2, 4);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2009-04-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2009-04-10'],
            ['2009-04-23']
        ...
        it "should include count recurrences" do
          executing([
            ...
            "insert into event_recurrences (event_id, week, day) values (1, 2, 5);",
            "insert into event_recurrences (event_id, week, day) values (1, -2, 4);",
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2011-06-25 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-05-25'],
            ['2009-05-08'],
            ['2009-05-21'],
      ...
      describe 'using a custom month and day of week in month' do
        it "should include the event on the specified days" do
          executing([
            ...
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2009-07-10 12:00pm', '0', NULL);"
          ]).should == [
            ['2008-04-25'],
            ['2008-07-11'],
            ['2008-07-24'],
        ...
        it "should include count recurrences" do
          executing([
            ...
            "select distinct date from recurring_events_for('2007-04-01 12:00pm', '2010-07-10 12:00pm', '0', NULL);"
          ]).should == [
            ['2009-04-25'],
            ['2009-05-08'],
            ['2009-05-21'],
