...
describe 'recurring_events_for' do
  describe 'on single day events:' do
    it "should include events on a date inside of the range" do
      executing([
        "insert into events (starts_at, frequency, is_full_day) values ('2008-04-25', 'once', true);",
    ...
    it "should not include events on a date outside of the range" do
      executing([
        "insert into events (starts_at, frequency, is_full_day) values ('2008-04-23', 'once', true);",
        "select starts_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-26 12:00pm', 'UTC', NULL);"
      ]).should == []
    end
    ...
    it "should ignore time values when fullDay is true and between is after timestamp" do
      executing([
        "insert into events (starts_at, frequency, is_full_day) values ('2021-01-25 09:00am', 'once', true);",
  ...
  describe 'on multi-day events:' do
    it "should include events starting and ending on the endpoints of the range" do
      executing([
        "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-04-24', '2008-04-25', 'once', true);",
    ...
    it "should include events starting and ending on the endpoints of the range and ignore time values" do
      executing([
        "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-04-24 09:00am', '2008-04-25 11:00pm', 'once', true);",
    ...
    it "should include events ending on the day the range begins" do
      executing([
        "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-04-20', '2008-04-24', 'once', true);",
        "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00pm', 'UTC', NULL);"
      ]).should == [
    ...
    it "should include events starting on the day the range ends" do
      executing([
        "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-04-25', '2008-04-26', 'once', true);",
        "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00pm', 'UTC', NULL);"
      ]).should == [
    ...
    it "should not include events starting after the range ends" do
      executing([
        "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-04-26', '2008-04-28', 'once', true);",
        "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00pm', 'UTC', NULL);"
      ]).should == []
    end
    ...
    it "should not include events ending before the range begins" do
      executing([
        "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-04-20', '2008-04-23', 'once', true);",
        "select starts_at, ends_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-25 12:00pm', 'UTC', NULL);"
      ]).should == []
    end
  end
  ...
  it "should not include the same date twice" do
    executing([
      "insert into events (id, starts_at, frequency, is_full_day) values (1, '2008-05-30', 'monthly', true);",
  ...
  describe 'time zone' do
    ...
    it "should take time zone into account when deciding whether or not a date is in the range" do
      executing([
        "insert into events (starts_at, frequency, is_full_day) values ('2008-05-12', 'once', true);",
  ...
  describe 'recurring' do
    describe 'time zone' do
      ...
      it "should take time zone into account when deciding whether or not a date is in the range" do
        executing([
          "insert into events (starts_at, frequency, is_full_day) values ('2008-05-12', 'weekly', true);",
      ...
      it "should take time zone into account when deciding whether a day of a multi-day event is in the range" do
        executing([
          "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2008-05-12', '2008-05-13', 'weekly', true);",
      ...
      it "should take daylight savings time into account when deciding whether a day of a multi-day event is in the range" do
        executing([
          ...
          "insert into events (starts_at, ends_at, frequency, is_full_day) values ('2009-02-24', '2009-03-09', 'yearly', true);",
    ...
    it "should only include events before or on the until date" do
      executing([
        "insert into events (starts_at, frequency, until, is_full_day) values ('2008-04-25', 'daily', '2008-04-27', true);",
    ...
    it "should only include events for count recurrences" do
      executing([
        "insert into events (starts_at, frequency, count, is_full_day) values ('2008-04-25', 'daily', 3, true);",
        "select starts_at from recurring_events_for('2008-04-24 12:00pm', '2008-04-29 12:00pm', 'UTC', NULL);"
      ]).should == [
        ['2008-04-25 00:00:00'],
        ['2008-04-26 00:00:00'],
    ...
    it "should only include limit recurrences of each event" do
      executing([
        "insert into events (starts_at, frequency, is_full_day) values ('2008-04-20', 'daily', true);",
        "insert into events (starts_at, frequency, is_full_day) values ('2008-04-25', 'daily', true);",
    ...
    describe 'mutliple recurrence rules' do
      it "should only include events for count recurrences" do
        executing([
          "insert into events (id, starts_at, frequency, count, is_full_day) values (1, '2008-04-25', 'monthly', 3, true);",
      ...
      it "should only include limit recurrences of each event" do
        executing([
          "insert into events (id, starts_at, frequency, is_full_day) values (1, '2008-04-20', 'monthly', true);",
          "insert into event_recurrences (event_id, day) values (1, 28);",
          "insert into event_recurrences (event_id, day) values (1, 4);",
          "insert into events (id, starts_at, frequency, is_full_day) values (2, '2008-04-25', 'monthly', true);",
      ...
      it "should put separation in between each recurrence" do
        executing([
          "insert into events (id, starts_at, frequency, separation, is_full_day) values (1, '2008-04-25', 'monthly', 2, true);",
          "insert into event_recurrences (event_id, day) values (1, 28);",
          "insert into event_recurrences (event_id, day) values (1, 4);",
    ...
    describe 'cancellations' do
      it "should not include cancelled recurrences" do
        executing([
          "insert into events (id, starts_at, frequency, is_full_day) values (1, '2008-04-25', 'daily', true);",
      ...
      it "should not include additional recurrences for events restricted by count" do
        executing([
          "insert into events (id, starts_at, frequency, count, is_full_day) values (1, '2008-04-25', 'daily', 3, true);",
          "insert into event_cancellations (event_id, date) values (1, '2008-04-26')",
    ...
    describe 'daily' do
      ...
      it "should put separation in between each recurrence" do
        executing([
          "insert into events (starts_at, frequency, separation, is_full_day) values ('2008-04-25', 'daily', 2, true);",
    ...
    describe 'weekly' do
      it "should include the event once for each week" do
        executing([
          "insert into events (starts_at, frequency, is_full_day) values ('2008-04-25', 'weekly', true);",
      ...
      it "should put separation in between each recurrence" do
        executing([
          "insert into events (starts_at, frequency, separation, is_full_day) values ('2008-04-25', 'weekly', 2, true);",
      ...
      describe 'using a custom day of week' do
        it "should include the event once for each occurrence" do
          executing([
            "insert into events (id, starts_at, frequency, is_full_day) values (1, '2008-04-25', 'weekly', true);",
        ...
        it "should put separation in between each recurrence" do
          executing([
            "insert into events (id, starts_at, frequency, separation, is_full_day) values (1, '2008-04-25', 'weekly', 2, true);",
            "insert into event_recurrences (event_id, day) values (1, 2);",
            "insert into event_recurrences (event_id, day) values (1, 4);",
    ...
    describe 'monthly' do
      it "should include the event once for each month" do
        executing([
          "insert into events (starts_at, frequency, is_full_day) values ('2008-04-25', 'monthly', true);",
      ...
      it "should maintain the day of month for events at the end of the month" do
        executing([
          "insert into events (starts_at, frequency, is_full_day) values ('2008-05-31', 'monthly', true);",
      ...
      it "should put separation in between each recurrence" do
        executing([
          "insert into events (starts_at, frequency, separation, is_full_day) values ('2008-04-25', 'monthly', 2, true);",
      ...
      describe 'using a custom day of month' do
        it "should include the event on the specified days" do
          executing([
            "insert into events (id, starts_at, frequency, is_full_day) values (1, '2008-04-25', 'monthly', true);",
            "insert into event_recurrences (event_id, day) values (1, 28);",
            "insert into event_recurrences (event_id, day) values (1, 4);",
      ...
      describe 'using a custom day of week in month' do
        ...
        it "should not include additional recurrences when the range starts after the event" do
          executing([
            "insert into events (id, starts_at, frequency, count, is_full_day) values (1, '2008-04-25', 'monthly', 5, true);",
            "insert into event_recurrences (event_id, week, day) values (1, 2, 5);",
            "insert into event_recurrences (event_id, week, day) values (1, -2, 4);",
    ...
    describe 'yearly' do
      it "should include the event once for each year" do
        executing([
          "insert into events (starts_at, frequency, is_full_day) values ('2008-04-25', 'yearly', true);",
      ...
      it "should put separation in between each recurrence" do
        executing([
          "insert into events (starts_at, frequency, separation, is_full_day) values ('2008-04-25', 'yearly', 2, true);",
      ...
      describe 'using a custom month' do
        it "should include the event in the specified months" do
          executing([
            "insert into events (id, starts_at, frequency, is_full_day) values (1, '2008-04-25', 'yearly', true);",
      ...
      describe 'using a custom day of month' do
        ...
        it "should put separation in between each recurrence" do
          executing([
            "insert into events (id, starts_at, frequency, separation, is_full_day) values (1, '2008-04-25', 'yearly', 2, true);",
            "insert into event_recurrences (event_id, day) values (1, 28);",
            "insert into event_recurrences (event_id, day) values (1, 7);",
